...
<header class="main-header header-style-two">
    <div class="auto-container">
      ...
      <div class="main-box">
        ...
        <div class="nav-outer">
          <div class="logo-box">
            <div class="logo"><a href="index-2.html"><img style="height: 90px; width: 90px;" src="/logos/IandM-no-bg-logo-.png" alt="" title=""></a></div>
          </div>
                  ...
                  <div class="mega-menu-bar row pt-0">
                    <div class="column col-lg-3 col-md-3 col-sm-12">
                      <ul>
                        ...
                        <li class="current"><a href="index-3.html">Home Page 02</a></li>
                    ...
                    <div class="column col-lg-3 col-md-3 col-sm-12">
                      <ul>
                        ...
                        <li><a href="index-10.html">Home Page 09</a></li>
                        <li><a href="index-11.html">Home Page 10</a></li>
                      </ul>
                    </div>

                    <div class="column col-lg-3 col-md-3 col-sm-12">
                      <ul>
                        <li><a href="index-12.html">Home Page 11</a></li>
                        <li><a href="index-13.html">Home Page 12</a></li>
                        <li><a href="index-14.html">Home Page 13</a></li>
                        <li><a href="index-15.html">Home Page 14</a></li>
                        <li><a href="index-16.html">Home Page 15</a></li>
                      </ul>
                    </div>

                    <div class="column col-lg-3 col-md-3 col-sm-12">
                      <ul>
                        <li><a href="index-17.html">Home Page 16</a></li>
                        <li><a href="index-18.html">Home Page 17</a></li>
                        <li><a href="index-19.html">Home Page 18</a></li>
                      <li><a href="index-20.html">Home Page 19</a></li>
                      <li><a href="index-21.html">Home Page 20</a></li>
                      <li><a href="index-22.html">Home Page 21</a></li>
                      <li><a href="index-23.html">Home Page 22</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
    ...
    <div class="mobile-header">
      ...
      <div class="nav-outer clearfix">
        ...
        <div class="outer-box">
          <!-- Login/Register -->
          <div class="login-box">
            <a href="login-popup.html" class="call-modal"><span><i class="fa fa-user"></i></span></a>
          </div>

          <a href="#nav-mobile" class="mobile-nav-toggler navbar-trigger"><span> <i class="fa fa-bars"></i></span></a>
        </div>
      </div>
    </div>
