    ...
    <div class="auto-container">
      <div class="row">
        ...
        <div class="image-column col-lg-5 col-md-12">
          <div class="image-box">
            <figure class="main-image anm" data-wow-delay="1000ms" data-speed-x="2" data-speed-y="2"><img src="/onboarding/images/resource/banner-img-2.png" alt=""></figure>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="auto-container">
      ...
      <div class="row wow fadeInUp">
        ...
        <div class="job-block-two col-lg-12">
          <div class="inner-box">
            <div class="content">
              <span class="company-logo"><img src="/onboarding/images/resource/company-logo/1-1.png" alt=""></span>
        ...
        <div class="job-block-two col-lg-12 col-md-12 col-sm-12">
          <div class="inner-box">
            <div class="content">
              <span class="company-logo"><img src="/onboarding/images/resource/company-logo/1-2.png" alt=""></span>
        ...
        <div class="job-block-two col-lg-12 col-md-12 col-sm-12">
          <div class="inner-box">
            <div class="content">
              <span class="company-logo"><img src="/onboarding/images/resource/company-logo/1-3.png" alt=""></span>
        ...
        <div class="job-block-two col-lg-12 col-md-12 col-sm-12">
          <div class="inner-box">
            <div class="content">
              <span class="company-logo"><img src="/onboarding/images/resource/company-logo/1-6.png" alt=""></span>
        ...
        <div class="job-block-two col-lg-12 col-md-12 col-sm-12">
          <div class="inner-box">
            <div class="content">
              <span class="company-logo"><img src="/onboarding/images/resource/company-logo/1-4.png" alt=""></span>
      ...
      <div class="row wow fadeInUp">
        <div class="column col-lg-4 col-md-6 col-sm-12">
          ...
          <div class="feature-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/featured-1.png" alt=""></figure>
        ...
        <div class="column col-lg-4 col-md-6 col-sm-12">
          ...
          <div class="feature-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/featured-2.png" alt=""></figure>
              <div class="overlay-box">
                <div class="content">
                  <h5>Paris</h5>
                  <span class="total-jobs">12 Jobs</span>
          ...
          <div class="feature-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/featured-4.png" alt=""></figure>
              <div class="overlay-box">
                <div class="content">
                  <h5>Miami</h5>
                  <span class="total-jobs">12 Jobs</span>
        ...
        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
          ...
          <div class="feature-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/featured-3.png" alt=""></figure>
              <div class="overlay-box">
                <div class="content">
                  <h5>London</h5>
                  <span class="total-jobs">12 Jobs</span>
          ...
          <div class="feature-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/featured-5.png" alt=""></figure>
              <div class="overlay-box">
                <div class="content">
                  <h5>Los Angeles</h5>
                  <span class="total-jobs">12 Jobs</span>
    ...
    <div class="auto-container">
      ...
      <div class="carousel-outer wow fadeInUp">
        <div class="candidates-carousel owl-carousel owl-theme default-dots">
          ...
          <div class="candidate-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/candidate-2.png" alt=""></figure>
          ...
          <div class="candidate-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/candidate-3.png" alt=""></figure>
          ...
          <div class="candidate-block">
            <div class="inner-box">
              <figure class="image"><img src="/onboarding/images/resource/candidate-4.png" alt=""></figure>
    ...
    <div class="auto-container">
      ...
      <div class="row wow fadeInUp">
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image-box">
              <figure class="image"><img src="/onboarding/images/resource/news-1.jpg" alt="" /></figure>
            </div>
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image-box">
              <figure class="image"><img src="/onboarding/images/resource/news-2.jpg" alt="" /></figure>
            </div>
            <div class="lower-content">
              <ul class="post-meta">
                <li><a href="#">August 31, 2021</a></li>
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image-box">
              <figure class="image"><img src="/onboarding/images/resource/news-3.jpg" alt="" /></figure>
            </div>
            <div class="lower-content">
              <ul class="post-meta">
                <li><a href="#">August 31, 2021</a></li>
